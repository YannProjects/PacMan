...
#
# Generated by export_simulation on Sat Feb 03 22:01:04 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './pacman_ram_v2.sh' script.

./pacman_ram_v2.sh -reset_run
...
./pacman_ram_v2.sh -noclean_files

For more information on the script, please type './pacman_ram_v2.sh -help'.
