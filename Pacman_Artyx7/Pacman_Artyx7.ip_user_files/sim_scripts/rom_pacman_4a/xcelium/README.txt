...
#
# Generated by export_simulation on Sat Jun 24 18:30:21 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './rom_pacman_4a.sh' script.

./rom_pacman_4a.sh -reset_run
...
./rom_pacman_4a.sh -noclean_files

For more information on the script, please type './rom_pacman_4a.sh -help'.
