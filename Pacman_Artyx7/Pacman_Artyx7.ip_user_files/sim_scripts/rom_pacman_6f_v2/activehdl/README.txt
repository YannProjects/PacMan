...
#
# Generated by export_simulation on Sat Jun 24 18:00:59 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './rom_pacman_6f_v2.sh' script.

./rom_pacman_6f_v2.sh -reset_run
...
./rom_pacman_6f_v2.sh -noclean_files

For more information on the script, please type './rom_pacman_6f_v2.sh -help'.
