...
#
# Generated by export_simulation on Sat Jun 24 18:27:16 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './rom_pacman_5e.sh' script.

./rom_pacman_5e.sh -reset_run
...
./rom_pacman_5e.sh -noclean_files

For more information on the script, please type './rom_pacman_5e.sh -help'.
