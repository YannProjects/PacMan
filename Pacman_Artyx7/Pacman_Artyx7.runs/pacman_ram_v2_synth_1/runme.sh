...
HD_PWD='C:/Users/yannv/Documents/Projets_HW/PacMan/PacMan_v2_AIO/Pacman_Artyx7/Pacman_Artyx7.runs/pacman_ram_v2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pacman_ram_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pacman_ram_v2.tcl
