...
HD_PWD='C:/Users/yannv/Documents/Projets_HW/PacMan_v2/Pacman_Artyx7/Pacman_Artyx7.runs/rom_pacman_4a_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_pacman_4a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_pacman_4a.tcl
